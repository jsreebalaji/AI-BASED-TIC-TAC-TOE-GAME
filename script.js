...
function isBoardPristine() {
    return board.every(row => row.every(cell => cell === "square-empty"));
}
...
function updateBoard() {
    ...
    if (isBoardPristine()) {
        ...
        restartBtn.style.display = "inline-block"; // or "block", depending on layout
    }
...
function restart() {
    ...
    // Hide restart button after restart
